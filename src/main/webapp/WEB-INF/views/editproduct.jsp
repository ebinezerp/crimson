						...
						<div class="row">
							...
							<div class="col-sm-12" id="productDescriptions">
								...
								<c:forEach items="${product.productDescriptions}" var="descriptionLine"
									varStatus="line">
									<springform:input type='hidden'
										path="productDescriptions[${line.index}].id" />
									<springform:input
								...
								<input type='button' id="addDescLineBtn" class='btn'
									style='margin-top: 20px; background-color: #ef402b; color: white'
									value='Add Description Line'>
							</div>
							...
							<div class="col-sm-12" id="productFeatures">
								...
								<c:forEach items="${product.productFeatures}" var="productFeaturesLine"
									varStatus="line">
									<springform:input type='hidden' path="productFeatures[${line.index}].id" />
									<springform:input path="productFeatures[${line.index}].feature" />
									<springform:errors class="error_msg"
										path="productFeatures[${line.index}].feature"></springform:errors>
								</c:forEach>
								<input type='button' id="addFeatureLineBtn" class='btn'
									style='margin-top: 20px; background-color: #ef402b; color: white'
									value='Add Product Feature'>
							</div>

							<div class="col-sm-12" id="productApplications">
								<label>Product Applications *</label>
								<c:forEach items="${product.productApplications}"
									var="productApplicationLine" varStatus="line">
									<springform:input type='hidden'
										path="productApplications[${line.index}].id" />
									<springform:input
										path="productApplications[${line.index}].application" />
									<springform:errors class="error_msg"
										path="productApplications[${line.index}].application"></springform:errors>
								</c:forEach>
								<input type='button' id="addApplicationLineBtn" class='btn'
									style='margin-top: 20px; background-color: #ef402b; color: white'
							...
							<div class="col-sm-12" id="packagings">
								...
								<c:forEach items="${product.packagings}" var="packagingLine"
									varStatus="line">
									<springform:input type='hidden' path="packagings[${line.index}].id" />
									<springform:input path="packagings[${line.index}].packaging" />
									<springform:errors class="error_msg"
										path="packagings[${line.index}].packaging"></springform:errors>
								</c:forEach>
								<input type='button' id="addPackagingLineBtn" class='btn'
									style='margin-top: 20px; background-color: #ef402b; color: white'
									value='Add Another Package'>
							</div>

							<div class="col-sm-12" id="productSpecifications">
								<label>Product Specifications *</label>
								<c:forEach items="${product.productSpecifications}"
									var="productSpecificationLine" varStatus="line">
									<springform:input type='hidden'
										path="productSpecifications[${line.index}].id" />
									<springform:input
										path="productSpecifications[${line.index}].specification" />
									<springform:errors class="error_msg"
										path="productSpecifications[${line.index}].specification"></springform:errors>
								</c:forEach>
								<input type='button' id="addSpecificationLineBtn" class='btn'
									style='margin-top: 20px; background-color: #ef402b; color: white'
									value='Add Another Specification'>
							</div>
							...
							<div class="col-sm-12 text-right">
								<a href="#" onclick="addproduct()" class="shp-btn">Update
									Product</a> <a href="${contextPath}/admin/disable/${product.id}"
									class="shp-btn btn-danger">Disable</a>
							</div>
						</div>
					</springform:form>
				</div>
