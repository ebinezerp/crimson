 ...
 * javax.persistence.OneToOne; import javax.validation.constraints.NotBlank;
 ...
 * @Entity
 * 
 * @Data public class OrderReciever {
 * 
 * @Id
 * 
 ...
 * 
 * @Size(min=4, message="company should atleast be 4 characters") private String
 * companyName;
 * 
 ...
 * 
 * @Pattern(regexp = "^[6-9]{1}[0-9]{9}$", message =
