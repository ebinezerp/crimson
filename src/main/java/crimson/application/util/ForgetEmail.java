	...
	public void send(String to, String content, String contextPath) {
		...
		javaMailSender.send(new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				messageHelper.setText("<p>We received a request to reset the password associated with this e-mail address. If you made this request, please follow the instructions below.</p>\r\n" + 
						"<p>Click the link below to reset your password using our secure server:</p>\r\n" + 
						"<a href='http://crimsontrading.in/resetpassword'>Reset Password</a>\r\n" + 
